...
resource "aws_s3_bucket_object" "delta_insert" {
    ...
    acl = "private"
    source = "../etl/01/01_delta_spark_insert.py"
    etag = filemd5("../etl/01/01_delta_spark_insert.py")
}
...
resource "aws_s3_bucket_object" "delta_upsert" {
    ...
    acl = "private"
    source = "../etl/01/02_delta_spark_upsert.py"
    etag = filemd5("../etl/01/02_delta_spark_upsert.py")
}